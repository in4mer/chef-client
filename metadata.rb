...
recipe 'chef-client::cron', 'deprecated; sets up config to run chef-client as a recurring task under cron'
recipe 'chef-client::cron_service', 'old cron.rb renamed to allow init_style set to cron'
